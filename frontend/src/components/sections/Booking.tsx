    ...
    <section id="booking" className="py-24 bg-primary dark:bg-[#0a0908] relative overflow-hidden z-10">
      ...
      <div className="container mx-auto px-4 relative z-10" ref={ref as React.RefObject<HTMLDivElement>}>
        <div className="flex flex-col lg:flex-row gap-16 items-center">
          ...
          <div className="reveal w-full lg:w-5/12 text-white">
            ...
            <div className="flex flex-col items-center sm:items-start gap-1 text-xl font-serif">
              ...
              <a href="tel:+919795756509" className="text-accent font-bold hover:underline">+91 97957 56509</a>
              <a href="tel:+918318635270" className="text-accent font-bold hover:underline">+91 83186 35270</a>
            </div>
          </div>

          <div className="reveal reveal-right delay-2 w-full lg:w-7/12">
            <div className="bg-card rounded-3xl p-8 md:p-10 shadow-2xl">
              ...
              {isSuccess ? (
                <div className="flex flex-col items-center justify-center py-12 text-center animate-slide-in-up">
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div className="space-y-2">
                      ...
                      <input name="check_in" type="date" required className="w-full px-4 py-3 rounded-xl border border-primary/20 dark:border-white/10 bg-transparent dark:bg-white/5 focus:outline-none focus:ring-2 focus:ring-primary/50 focus:border-transparent transition" />
                    </div>
                    <div className="space-y-2">
                      <label className="text-sm font-medium text-foreground/80 flex items-center gap-2">
                        <Calendar size={16} /> Check-out Date
                      </label>
                      <input name="check_out" type="date" required className="w-full px-4 py-3 rounded-xl border border-primary/20 dark:border-white/10 bg-transparent dark:bg-white/5 focus:outline-none focus:ring-2 focus:ring-primary/50 focus:border-transparent transition" />
                    </div>
                  </div>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div className="space-y-2">
                      ...
                      <input name="name" type="text" required placeholder="John Doe" className="w-full px-4 py-3 rounded-xl border border-primary/20 dark:border-white/10 bg-transparent dark:bg-white/5 focus:outline-none focus:ring-2 focus:ring-primary/50 focus:border-transparent transition" />
                    </div>
                  </div>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div className="space-y-2">
                      ...
                      <input name="phone" type="tel" required placeholder="+91 98765 43210" className="w-full px-4 py-3 rounded-xl border border-primary/20 dark:border-white/10 bg-transparent dark:bg-white/5 focus:outline-none focus:ring-2 focus:ring-primary/50 focus:border-transparent transition" />
                    </div>
                    <div className="space-y-2">
                      <label className="text-sm font-medium text-foreground/80 flex items-center gap-2">
                        <Mail size={16} /> Email Address (Optional)
                      </label>
                      <input name="email" type="email" placeholder="john@example.com" className="w-full px-4 py-3 rounded-xl border border-primary/20 dark:border-white/10 bg-transparent dark:bg-white/5 focus:outline-none focus:ring-2 focus:ring-primary/50 focus:border-transparent transition" />
                    </div>
                  </div>

                  <div className="pt-4 flex flex-col sm:flex-row gap-4">
                    <Button type="submit" variant="gold" size="lg" className="flex-1 w-full text-lg" disabled={isSubmitting}>
                      {isSubmitting ? "Processing..." : "Confirm Booking"}
                    </Button>
                    <Button type="button" variant="outline" size="lg" className="flex-1 w-full text-lg border-primary dark:border-white/20 text-primary dark:text-white hover:bg-primary hover:text-white">
                      Call for Best Price
                    </Button>
                  </div>
                </form>
      ...
      {/* CSS toast notification — no framer-motion */}
      {toast && (
        <div className={`fixed bottom-6 right-6 flex items-center gap-3 px-4 py-3 rounded-lg shadow-xl text-white font-medium z-50 animate-slide-in-up ${
