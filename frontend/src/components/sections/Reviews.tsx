...
const ReviewCard = memo(({ review, index }: ReviewCardProps) => (
  <div className={`reveal ${delayClasses[index % delayClasses.length]} break-inside-avoid relative`}>
...
const defaultReviews: ReviewData[] = [
  { id: "rev1", name: "Rahul Verma", rating: 5, text: "Best location in Varanasi.", date: "1 month ago" },
  { id: "rev2", name: "Sneha Reddy", rating: 5, text: "Amazing stay with friends. Owner is very cooperative. Great location — highly recommended for a budget trip.", date: "2 months ago" },
  { id: "rev3", name: "Amit Kumar", rating: 5, text: "All sightseeing places were right in front. Owner was very helpful. Reasonable price too.", date: "3 months ago" },
  { id: "rev4", name: "Priya Singh", rating: 5, text: "Stayed with family. Completely safe and comfortable. All places to visit are right next to the hotel.", date: "4 months ago" },
  { id: "rev5", name: "Vikram Sharma", rating: 5, text: "Great hotel with perfect location. All tourist spots nearby. Owner is very nice and humble. Totally worth it.", date: "5 months ago" },
];
    ...
    <section className="py-24 bg-[var(--beige)] relative overflow-hidden z-10">
      <div className="container mx-auto px-4 relative z-10" ref={ref as React.RefObject<HTMLDivElement>}>
        <div className="text-center mb-20">
          <h2 className="reveal text-5xl md:text-6xl font-serif text-primary mb-6">
            Guest Experiences
          </h2>
          <div className="reveal reveal-scale delay-2 w-32 h-1 bg-accent mx-auto rounded-full" />
        </div>
