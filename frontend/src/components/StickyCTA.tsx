...
export default function StickyCTA() {
  ...
  return (
    <div
      className={cn(
        "fixed bottom-0 left-0 w-full z-50 md:hidden bg-card shadow-[0_-4px_15px_rgba(0,0,0,0.1)] rounded-t-2xl p-4 flex gap-4 transition-all duration-300 transform",
